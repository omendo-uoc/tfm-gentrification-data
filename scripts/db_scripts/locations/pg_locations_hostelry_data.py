...
CREATE TABLE IF NOT EXISTS locations_hostelry (
...
df.to_sql('locations_hostelry', engine, if_exists='replace', index=False)

print("\n---> Data successfully loaded in the table locations_hostelry ✅")