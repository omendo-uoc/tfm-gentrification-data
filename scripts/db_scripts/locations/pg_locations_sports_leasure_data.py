...
CREATE TABLE IF NOT EXISTS locations_sport_leasure (
...
file_path = 'data/raw/locations/tfm_loc_dep_ocio.csv'
df = pd.read_csv(file_path)

print(df.head())

df.to_sql('locations_sport_leasure', engine, if_exists='replace', index=False)

print("\n---> Data successfully loaded in the table locations_sport_leasure ✅")